...
if text and text:match('^الغاء €>>﷼~€££|€€| @(%S+)$') then
local UserName = text:match('^+}﷼}€|^{*>£} @(%S+)$')
if Redis:sismember(Fast.."Specialall:Group",senderr) then
testmod = true
elseif msg.Admin then
...
if text and text:match('^??>>|£|€|﷼kk @(%S+)$') then
local UserName = text:match('^kfkffk﷼•﷼€€€=+ @(%S+)$')
if not msg.Admin then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text and text:match('^الغاء €€€~€€~€~ @(%S+)$') then
local UserName = text:match('^الغاء €~€€~€<*<*<€ @(%S+)$')
if not msg.Admin then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text and text:match('^£<€<***#€€%'y' (%d+) (.*) @(%S+)$') then
local UserName = {text:match('^kfkfkgifi﷼﷼• (%d+) (.*) @(%S+)$') }
if not msg.Admin then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text and text:match('^??(((((()))))) (%d+) (.*)$') and msg.reply_to_message_id ~= 0 then
local TimeKed = {text:match('^4445565$$$&& (%d+) (.*)$') }
if not msg.Admin then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text and text:match('^2334€€﷼﷼﷼ (%d+) (.*) (%d+)$') then
local UserId = {text:match('^€€﷼﷼﷼•••++€€﷼﷼﷼ (%d+) (.*) (%d+)$') }
if not msg.Admin then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text and text:match('^ggj££€﷼﷼ @(%S+)$') then
local UserName = text:match('^€€﷼﷼€££**﷼﷼ @(%S+)$')
if not msg.Admin then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
...
if text and text:match('^﷼﷼﷼€﷼•••€> التقييد @(%S+)$') then
local UserName = text:match('^الغاء ﷼﷼££﷼﷼ @(%S+)$')
if not msg.Admin then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
...
if text == ('الغاء €€﷼﷼€€') and msg.reply_to_message_id ~= 0 then
if not msg.Devss then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(2)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text == ('الغاء ££€﷼﷼﷼•••') or text == ('الغاء ﷼﷼€£>>•=+') and   msg.reply_to_message_id ~= 0 then
if Redis:sismember(Fast.."Specialall:Group",senderr) then
testmod = true
elseif msg.Admin then
testmod = true
...
if text == ('الغاء €€€€﷼€€€•+*•') or text == ('•﷼﷼﷼• الكتم') and msg.reply_to_message_id ~= 0 then
if not msg.Admin then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text and text:match('^الغاء !&@&&@@& (%d+)$') then
local UserId = text:match('^الغاء $$&&)(;;@@&) (%d+)$')
if not msg.Devss then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(2)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text and text:match('^8754478﷼﷼€£€ (%d+)$') then
local UserId = tonumber(text:match('^﷼€££€••• (%d+)$'))
if not msg.Admin then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text == 'رفع bbgjtsdvhhhgh ' and msg.reply_to_message_id ~= 0 then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if text == 'جلب الردود gghkjfs£€*^%%*+=' then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Get_Json = '{"BotId": '..Fast..','  
...
if text == 'رفع الردود gghjkoojhUy5568' and msg.reply_to_message_id ~= 0 then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if text == '⦗ جلب الردود 77888&7££#^﷼﷼ ⦘' then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Get_Json = '{"BotId": '..Fast..','  
...
if text == '<>£€﷼•﷼€ الردود ttfcc445£€﷼•' and msg.reply_to_message_id ~= 0 then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
