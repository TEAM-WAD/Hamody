...
if text and text:match("^ddfggghhhhhhhhhjkkkkkkkjgf (.*)$") and msg.reply_to_message_id == 0 then
local TextMsg = text:match("^ddfggghhhhhhhhhjkkkkkkkjgf (.*)$")
...
if TextMsg == 'ddfggghhhhhhhhhjkkkkkkkjgf' then
...
if text and text:match('^ddfggghhhhhhhhhjkkkkkkkjgf @(%S+)$') then
local UserName = text:match('^ddfggghhhhhhhhhjkkkkkkkjgf @(%S+)$')
...
if text and text:match('^ddfggghhhhhhhhhjkkkkkkkjgf (%d+) (.*)$') and msg.reply_to_message_id ~= 0 then
local TimeKed = {text:match('^ddfggghhhhhhhhhjkkkkkkkjgf (%d+) (.*)$') }
if not msg.Admin then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text and text:match('^ddfggghhhhhhhhhjkkkkkkkjgf (%d+) (.*) (%d+)$') then
local UserId = {text:match('^ddfggghhhhhhhhhjkkkkkkkjgf (%d+) (.*) (%d+)$') }
if not msg.Admin then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text == ('ddfggghhhhhhhhhjkkkkkkkjgf') and msg.reply_to_message_id ~= 0 then
if not msg.Devss then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(2)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text == ('ddfggghhhhhhhhhjkkkkkkkjgf') or text == ('ddfggghhhhhhhhhjkkkkkkkjgf') and   msg.reply_to_message_id ~= 0 then
if Redis:sismember(Fast.."Specialall:Group",senderr) then
testmod = true
elseif msg.Admin then
testmod = true
...
if text and text:match('^ddfggghhhhhhhhhjkkkkkkkjgf (%d+)$') then
local UserId = text:match('^ddfggghhhhhhhhhjkkkkkkkjgf (%d+)$')
if not msg.Devss then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(2)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text and text:match('^ddfggghhhhhhhhhjkkkkkkkjgf (%d+)$') then
local UserId = tonumber(text:match('^ddfggghhhhhhhhhjkkkkkkkjgf (%d+)$'))
if not msg.Admin then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text == "ddfggghhhhhhhhhjkkkkkkkjgf" or text == "ddfggghhhhhhhhhjkkkkkkkjgf" then
...
if text == 'ddfggghhhhhhhhhjkkkkkkkjgf' then
...
if text == 'ddfggghhhhhhhhhjkkkkkkkjgf' and not Redis:get(Fast..'idnotmemname'..msg.chat_id)  then
local UserInfo = bot.getUser(senderr)
return send(msg_chat_id,msg_id,'\n↯︙ اسمك : *❪'..FlterBio(UserInfo.first_name)..'❫*', "md")
end
if text == 'ddfggghhhhhhhhhjkkkkkkkjgf' and not Redis:get(Fast..'idnotmembio'..msg.chat_id)  then
...
if text == 'ddfggghhhhhhhhhjkkkkkkkjgf' and not Redis:get(Fast..'Nzlne:Abs'..msg.chat_id) then
