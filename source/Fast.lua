...
local CmdStart = '*\n- اهلا عزيزي انا بوت عملي '..(Redis:get(Fast.."Name:Bot") or "⦗حذف محتوى اباحي⦘")..
'\nوضيفتي حمايه المجموعات من الاباحي والخ.. '..
'\nلتفعيل البوت ارفع البوت مشرف فقط '..
'\n- التحكم في البوت فقط من مالك الكروب'..
'\n- مطور البوت ~@'..UserSudo..'*'
