...
'\n- لتفعيلي ارفعني فقط سيتم تفعيلي تلقائياً '..
\n-  لاتتردد في تفعيلي انا اقوم بتنظيف اي محتوى اباحي ظار . '..
'\n- مطور البوت ~@'..UserSudo..'*'
if photo.total_count > 0 then
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '⦗ قناه البوت ⦘', callback_data = msg.sender_id.user_id..'/zxhaut'},{text = '⦗ مطور البوت ⦘',  callback_data = msg.sender_id.user_id..'/lhaui'},
},
{
{text = Name_dev, url = "t.me/"..UName_dev },
},
