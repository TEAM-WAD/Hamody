...
local list = Redis:smembers(Fast.."ChekBotAdd")
send(Sudo_Id,0,"*-  تم اضافه البوت في كروب جديد لم يتم رفعه مشرف ولاتم تفعيله حبيت ابلغك مطوري .*\n- عدد كروباتك حاليا *"..#list.."* مجموعه","md",true)
end
...
'\nوضيفتي تنظيف المجموعات من الاباحي والخ.. '..
...
keyboard.inline_keyboard = {
{
{text = '⦗ تحديث البوت ⦘', url = 'http://t.me/ioutb'},{text = '⦗ قناه البوت ⦘',  url = 'https://t.me/Broks_UP/35'},
},
{
{text = Name_dev, url = "t.me/"..UName_dev },
},
