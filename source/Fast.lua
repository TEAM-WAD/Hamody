...
if UserId == 2100004938 then
Status = 'مطور البوت  '
elseif UserId == 22222222 then
Status = 'مطـور السـورس '
elseif UserId == 222222222 then
Status = 'مطـور السـورس '
elseif UserId == 222222222 then
Status = 'مطـور السـورس '
elseif UserId == 222222222 then
...
Status = true
elseif UserId == 222222222222 then
Status = true
elseif UserId == 222222222222 then
Status = true
elseif UserId == 22222222 then
...
if UserId == 2100004938 then
Status = true
elseif UserId == 2222222 then
Status = true
elseif UserId == 5555555555 then
Status = true
elseif UserId == 223333333 then
Status = true
elseif UserId == 332222233 then
Status = true
elseif UserId == 3333333333 then
Status = true
elseif UserId == 33333333333 then
Status = true
elseif UserId == Sudo_Id then    
Status = true
elseif Controll2 then
...
local list = Redis:smembers(Fast.."ChekBotAdd")
send(Sudo_Id,0,"*↯︙ تم اضافه البوت في كروب جديد ولكن لم يتم رفع البوت مشرف *\n لم يتم تفعيل البوت فقط مضاف للكروب حبيت انبهك مطوري\n↯︙ عدد المجموعات حاليا *"..#list.."* مجموعه","md",true)
end
...
if text == 'ccvgffhh' or text == 'مطور ggjjjjhgggتبني' or text == 'منينبنبتذتذتذتتذنب' then   
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
...
if text == 'اعدادات كككةةكنتاهخخحج' then 
if not msg.Admin then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text == "ااتنمكةةجحنرزلبيي" then    
if not msg.Admin then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text == 'اللاتمكةةةججححكمة' then
if not msg.Admin then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
-----
if text == '﷼•﷼' or text == '€£﷼•' or text == 'يا ﷼•€€•'  then
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if text == "تغير ﷼€£﷼• ﷼" or text == "تغيير ﷼€£• ﷼€•£" then 
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text == (Redis:get(Fast.."Name:Bot") or "ddssssaaaasss") then
local photo = bot.getUserProfilePhotos(Fast)
if photo.total_count > 0 then
local NamesBot = (Redis:get(Fast.."Name:Bot") or "ddssssaaaasss")
local Mostafa = {
...
----
if text == "hhhhhasdfadf" or text == "ffffhhduuioppkcnvb" then
...
if text == "مسح تبنينيننبنبنبنبنبنر" then
if not msg.Admin then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
local reply_markup = bot.replyMarkup{
...
if text == 'ترتيب وذنبمبمصكيةدجججججمتن' then
if not msg.Manger then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(6)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text == 'استعاده ننبتبتتالاوامريحبيبيانته' then
if not msg.Manger then
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(6)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text == 'تحديث نلنبتتببنن ↯︙' or text == 'نلنبنلنلنلو' then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if not msg.Asasy then
if text == '/cccvdkdlcovpfjfhhskcjfl' then
...
if text == "نـسـبـة jdjdjdjhdjdjjcfj" then
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n↯︙ عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
if text == "نـسـبـة jfjfjfjjfjfjfjj" then
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n↯︙ عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
if text == "نـسـبـة jdjdjdjfjfjfjgj" then
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n↯︙ عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
if text == "نـسبـة jfjfjfjfjjfjfj" or text == "نـسبـة jfjfjfjfjjfj" and msg.reply_to_message_id ~= 0 then
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n↯︙ عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
if text == "نـسـبـة jdjdfjjfjfjfjgjvj" then
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n↯︙ عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
if text == "نـسـبـة jrjfjfjfjtjjn" or text == "نـسـبـة ktkoggoogjfjddn" and msg.reply_to_message_id ~= 0 then
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n↯︙ عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
local Name_dev = bot.getUser(Sudo_Id).first_name
local UName_dev = bot.getUser(Sudo_Id).username
local CmdStart = '*\n- اهلا عزيزي انا بوت عملي '..(Redis:get(Fast.."Name:Bot") or "⦗حذف محتوى الاباحي⦘")..
'\nوضيفتي تنظيف المجموعات من الاباحب والخ.. '..
'\nلتفعيل ومعلومات اكثر اضغط ع زر قناه البوت '..
'\nلمشاهده اخر التحديثات اضغط ع تحديثات البوت '..
'\n- مطور البوت ⦗@'..UserSudo..'⦘*'
if photo.total_count > 0 then
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '⦗ تحديثات البوت ⦘', url = 'http://t.me/ioutb},{text = '⦗ قناه البوت ⦘',  url = 'http://t.me/ioutb},
},
{
{text = Name_dev, url = "t.me/"..UName_dev },
},
