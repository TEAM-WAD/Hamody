...
if text == 'بروكسبيه يبني' or text == 'بنك مين يبني' then
...
{text = '- 𝖳𝖾𝖺𝗆 𝖡𝖱𝗈k𝖲.',url="t.me/ioubt"}, 
}
}
...
send(msg.chat_id,msg.id, "↯ ︙ فلوسك `"..convert_mony.."`  دولار 💵","md",true)
else
...
send(msg.chat_id,msg.id, "↯ ︙ فلوسه `"..convert_mony.."`  دولار 💵","md",true)
else
...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n↯ ︙ بروكس ماعندها حساب بالبنك 🤣","md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,"\n*↯ ︙ بروكس معندهوش حساب بالبنك 🤣*","md",true)  
return false
end
...
return bot.sendText(msg.chat_id,msg.id,"↯ ︙ ماتكدر تضارب الحين\n↯ ︙ تعال بعد "..math.floor(hours).." دقيقة","md",true)
end
...
return bot.sendText(msg.chat_id,msg.id,"↯ ︙ ماتكدر تستثمر الحين\n↯ ︙ تعال بعد "..math.floor(hours).." دقيقة","md",true)
end
...
return bot.sendText(msg.chat_id,msg.id,"↯ ︙ ماتكدر تلعب سحب الحين\n↯ ︙ تعال بعد "..math.floor(hours).." دقيقة","md",true)
end
bot.sendText(msg.chat_id,msg.id, "↯ ︙ استعمل الامر كذا :\n\n↯ ︙ `سحب` المبلغ","md",true)
end
if text == 'حظ' then
...
return bot.sendText(msg.chat_id,msg.id,"↯ ︙ ماتكدر تلعب حظ الحين\n↯ ︙ تعال بعد "..math.floor(hours).." دقيقة","md",true)
end
bot.sendText(msg.chat_id,msg.id, "↯ ︙ استعمل الامر كذا :\n\n↯ ︙ `حظ` المبلغ","md",true)
end
...
send(msg.chat_id,msg.id, "↯ ︙ حوالة صادرة من بنك بروكس\n\n↯ ︙ المرسل : "..news.."\n↯ ︙ الحساب رقم : `"..cccc.."`\n↯ ︙ نوع البطاقة : "..uuuu.."\n↯ ︙ المستلم : "..newss.."\n↯ ︙ الحساب رقم : `"..text.."`\n↯ ︙ نوع البطاقة : "..fsvhh.."\n↯ ︙ خصمت 10% رسوم تحويل\n↯ ︙ المبلغ : "..convert_mony.."  دولار 💵","md",true)
send(fsvhhh,0, "↯ ︙ حوالة واردة من بنك بروكس\n\n↯ ︙ المرسل : "..news.."\n↯ ︙ الحساب رقم : `"..cccc.."`\n↯ ︙ نوع البطاقة : "..uuuu.."\n↯ ︙ المبلغ : "..convert_mony.."  دولار 💵","md",true)
Redis:del(Fast.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
Redis:del(Fast.."transn" .. msg.sender_id.user_id)
else
...
shkse = Redis:get(Fast.."shkse"..msg.sender_id.user_id)
if shkse == "طيبة" then
return bot.sendText(msg.chat_id,msg.id, "↯ ︙ شخصيتك طيبة ماتكدر تاخذ رشوة","md",true)
end
local daddd = {"1", "2", "3", "4",}
...
shkse = Redis:get(Fast.."shkse"..msg.sender_id.user_id)
if shkse == "شريرة" then
return bot.sendText(msg.chat_id,msg.id, "↯ ︙ شخصيتك شريرة ماتكدر تاخذ بخشيش","md",true)
end
...
return send(msg.chat_id,msg.id, "↯ ︙ ماتكدر تزرفه فلوسه اقل من 200  دولار 💵","md",true)
end
...
return send(msg.chat_id,msg.id, "↯ ︙ ماتكدر تطور راتبك تحتاج مبلغ 1000000000  دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "↯ ︙ ماتكدر تطور راتبك تحتاج مبلغ 200000000  دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "↯ ︙ ماتكدر تطور راتبك تحتاج مبلغ 30000000  دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "↯ ︙ ماتكدر تطور راتبك تحتاج مبلغ 1000000  دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "↯ ︙ ماتكدر تطور راتبك تحتاج مبلغ 300000  دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "↯ ︙ ماتكدر تطور راتبك تحتاج مبلغ 120000  دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "↯ ︙ ماتكدر تطور راتبك تحتاج مبلغ 80000  دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "↯ ︙ ماتكدر تطور راتبك تحتاج مبلغ 30000  دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "↯ ︙ ماتكدر تطور راتبك تحتاج مبلغ 3000  دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "↯ ︙ ماتكدر تهجم فلوسك اقل من 100000  دولار 💵","md",true)
end
if tonumber(ballanceed) < 100000 then
return send(msg.chat_id,msg.id, "↯ ︙ ماتكدر تهجم عليه فلوسه اقل من 100000  دولار 💵","md",true)
end
...
return bot.sendText(msg.chat_id,msg.id, "↯ ︙ ماتكدر تشتري فلوسك مش مكفيه","md",true)
end
...
local nadebott = {"اشبيلية", "ريفر بلايت", "ريفر بلايت", "بوروسيا", "أياكس الهولندي", "ليون", "شاختار دونيتسك", "روما", "فياريال", "بوكا جونيورز", "نابولي", "بنفيكا", "فلامنجو", "ليستر سيتي", "بالمرسي", "ليل", "ريال سوسيداد", "ايندهوفن", "الأهلي المصري", "البروكسالسعودي", "الاتحاد السعودي",}
...
return bot.sendText(msg.chat_id,msg.id, "↯ ︙ الحد الاعلى المسموح هو 1k  دولار 💵\n ","md",true)
end
if tonumber(coniss) < 999 then
return bot.sendText(msg.chat_id,msg.id, "↯ ︙ الحد الادنى المسموح هو 1000  دولار 💵\n ","md",true)
end
...
Redis:setex(Fast.."aglahd" .. msg.sender_id.user_id,1800, true)
    local msg_text = ""
    local photo = "https://t.me/kTOO9K/4"
    local msg_reply = msg.id/2097152/0.5
    local keyboard = {}
    keyboard.inline_keyboard = {
      {
      {text = '- فر العجله ', callback_data=msg.sender_id.user_id.."/happywheel"},
      },
      }
